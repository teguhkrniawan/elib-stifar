                ...
                <div class="col-span-8 bg-white shadow">
                    <div class="p-5">
                        <form id="formLoan">
                            ...
                            <input type="hidden" name="idPeminjaman" value="{{ $id_peminjaman }}">
                            <div class="flex justify-between mb-3 px-3">
                                <h3 class="font-bold">BUKU DIPINJAM <span id="jlh-buku">({{ $jumlah }})</span></h3>
                            ...
                            <div class="flex justify-center hidden" id="container-btn">
                                <button type="submit" id="btn-pinjam"
                                    class="text-center w-[30%] py-3 text-white rounded-full font-bold mt-5 bg-emerald-800">KEMBALIKAN
                                    BUKU</button>
                            </div>
                        </form>
                    </div>
...
@push('script')
    ...
    @include('pengembalian.actionSearchBuku')
    @include('pengembalian.actionKembalikan')
