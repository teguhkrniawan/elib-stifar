...
<body>
    <div class="w-full bg-gray-200 h-screen flex justify-center font-bold">
        <div class="flex flex-col w-[300px] p-3 bg-white">
            ...
            <p class="text-xs mt-5">Dibuat: {{ date( 'd/m/Y' ,strtotime(date("Y-m-d"))) }}</p>
            <p class="text-xs">Jatuh tempo: {{ date( 'd/m/Y' ,strtotime($master_pengembalian->tanggal_jatuh_tempo)) }}</p>
            <p class="text-xs">NIM : {{ $master_pengembalian->nim }}</p>
            ...
            <div class="text-center text-xs mt-[30px] pb-5">
                ...
                <p>simpan resi ini, dan tunjukkan ke petugas sebagai bukti pengembalian buku</p>
            </div>
        </div>
    </div>
